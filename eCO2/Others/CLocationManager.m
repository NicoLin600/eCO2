...
@property (nonatomic) CLocationManagerGPSSignalStrength signalStrength;
...
+ (id)sharedLocationManager {
    ...
    static CLocationManager *locationManagerSingleton = nil;
...
- (void)setSignalStrength:(CLocationManagerGPSSignalStrength)signalStrength {
